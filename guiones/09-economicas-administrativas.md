# 09 — Facultad de Ciencias Económicas y Administrativas
...
- **"Pero no."** — dos palabras, punto. Es el giro y necesita el silencio
  después.
- **"decidir sin tener toda la información"** — es la definición que hace
  interesante la carrera. Va sin prisa.
- **"Detrás de cada cifra hay alguien."** — remate. Sin solemnidad, como quien
  dice una regla práctica. Es la línea que conecta con el enfoque
  biopsicosocial de la Universidad sin nombrarlo.

## Nota de contenido

Los dos programas salieron de fuentes públicas y **están sin confirmar**.
