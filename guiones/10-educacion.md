...
- **"nadie termina de aprender a enseñar"** — la línea del capítulo. Lenta, sin
  subrayarla. Si se dice como frase de cartel, se cae.
...
verificar. Si confirmas la oferta de la Facultad, entran justo antes del
remate.

## Por qué cierra la serie

Es el capítulo donde **la invitación deja de ser sobre una facultad y pasa a
ser sobre quien está mirando**. Cierra el arco que abrió el capítulo cero con
"gané por preguntona".
